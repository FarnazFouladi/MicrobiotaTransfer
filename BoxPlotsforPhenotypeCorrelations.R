...
plot<-myPlot(myT1,"Phylum",time=2,"Fat mass percentage change")+
  geom_signif(y_position=c(3.5, 3.5), xmin=c(2), xmax=c(3),annotation=c("*"), tip_length=0,vjust = 0.5,textsize =4)
myList[[index]]<-plot
index<-index+1
...
plot<-myPlot(myT1,"Class",time=3,"Fat mass percentage change")+
  geom_signif(y_position=c(3), xmin=c(3), xmax=c(5),annotation=c("**"), tip_length=0,vjust = 0.5,textsize =4)
myList[[index]]<-plot
index<-index+1
...
plot<-myPlot(myT1,"Order",time=3,"Fat mass percentage change")+
  geom_signif(y_position=c(3), xmin=c(1), xmax=c(4),annotation=c("**"), tip_length=0,vjust = 0.5,textsize =3)
myList[[index]]<-plot
index<-index+1
...
plot<-myPlot(myT1,"Order",time=4,"Fat mass percentage change")+
  geom_signif(y_position=c(4,3.8,3.6), xmin=c(1,1,1), xmax=c(4,5,8),annotation=c("***","**","*"), tip_length=0,vjust = 0.5,textsize =3)
myList[[index]]<-plot
index<-index+1
...
plot<-myPlot(myT1,"Family",time=3,"Fat mass percentage change")+
  geom_signif(y_position=c(3.2,3.4,3.6,3.8), xmin=c(2,2,2,2), xmax=c(6,13,14,21),annotation=c("*","*","*","*"), tip_length=0,vjust = 0.5,textsize =2)
myList[[index]]<-plot
index<-index+1
...
plot<-myPlot(myT1,"Family",time=4,"Fat mass percentage change")+
  geom_signif(y_position=c(3.6,3.8,4,4.2,4.4,4.6,4.8,5), xmin=c(6,6,11,11,14,14,18,20), xmax=c(18,20,18,20,18,20,21,21),annotation=c("**","*","*","*","**","**","***","**"), tip_length=0,vjust = 0.5,textsize =2)
myList[[index]]<-plot
index<-index+1
